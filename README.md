...
`CONFLUENCE_PAGE_ID` — опционально: если задан, FAQ-бот использует ТОЛЬКО эту
закрепленную страницу вместо CQL-поиска по всему Confluence (надежнее для
случаев, когда весь нужный контекст лежит в одном месте).
